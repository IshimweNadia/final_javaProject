...
public class issueBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("potential Book user");
        ...
        bookIssue.setBackground(new java.awt.Color(0, 51, 153));
        bookIssue.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        bookIssue.setForeground(new java.awt.Color(255, 255, 255));
        bookIssue.setText("check book k issue List");
        bookIssue.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 153, 255), 3));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bookIssue, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(91, Short.MAX_VALUE))
        );

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 102));
        jLabel5.setText("BOOKS ISSUES RECORDING");

        jback10.setBackground(new java.awt.Color(0, 0, 102));
        jback10.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jback10.setForeground(new java.awt.Color(255, 255, 255));
        jback10.setText("back home");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sqll = "insert into book_in_use(book_id,current_BookUser,takeOutDate,returnInDate) values(?,?,?,?)";
        ...
        try {
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(this, "book is issued to" +bookuser);
            con.close();
    ...
    private void bookIssueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookIssueActionPerformed
        // TODO add your handling code here:
        issuedBookList blis=new issuedBookList();
        issueBooks bReg=new issueBooks();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        searchRegisteredBook srchbook= new searchRegisteredBook();
        srchbook.setVisible(true);
    ...
    private javax.swing.JButton jback10;
